...
export default function Section9() {
  return (
    <section className="w-full h-[689.6rem] md:h-[133.75rem] flex flex-col relative overflow-hidden max-md:pt-[17.07rem]">
      <div className="w-full h-[61.87rem] md:h-[32.37rem] bg-white absolute top-0 right-0"></div>
      ...
      <Image
        ...
        className="w-[133.06667rem] h-[144rem] md:w-[58.8125rem] md:h-[66.25rem] absolute bottom-0 max-md:right-0 md:-left-[4.31rem] object-cover"
      />
    </section>
  );
}
